 ...
 */
declare function optIn(signer: any, channelAddress: string, chainId: number, userAddress: string, baseApiUrl?: string, verifyingContractAddress?: string): Promise<{
    status: string;
    message: any;
}>;
/**
 ...
 * @param verifyingContractAddress (optional) The address of the communicator contract to be used, defaults to EPNS_COMM_CONTRACT
 */
declare function optOut(signer: any, channelAddress: string, chainId: number, userAddress: string, baseApiUrl?: string, verifyingContractAddress?: string): Promise<{
    status: string;
    message: any;
}>;
