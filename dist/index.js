...
var ImageWrapper = styled__default['default'].div(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["\n    height: 100vh;\n    width: 100vw;\n    background: rgba(0,0,0,0.75);\n    position: fixed;\n    top: 0;\n    left: 0;\n    justify-content: center;\n    align-items: center;\n    display: ", ";\n    z-index: 2;\n\n    img{\n        width: 80vw;\n        height: auto;\n        border-radius: 10px;\n    }\n"], ["\n    height: 100vh;\n    width: 100vw;\n    background: rgba(0,0,0,0.75);\n    position: fixed;\n    top: 0;\n    left: 0;\n    justify-content: center;\n    align-items: center;\n    display: ", ";\n    z-index: 2;\n\n    img{\n        width: 80vw;\n        height: auto;\n        border-radius: 10px;\n    }\n"])), function (props) { return props.visible ? 'flex' : 'none'; });
...
var StyledCircularLoader2 = styled__default['default'].div(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n    width: 20px;\n    height: 20px;\n    .lds-ring {\n        display: inline-block;\n        position: relative;\n        width: 20px;\n        height: 20px;\n    }\n    .lds-ring div {\n        box-sizing: border-box;\n        display: block;\n        position: absolute;\n        width: 20px;\n        height: 20px;\n        margin: 0px;\n        border: 2px solid ", ";\n        border-radius: 50%;\n        animation: lds-ring 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite;\n        border-color: ", " transparent transparent transparent;\n    }\n    .lds-ring div:nth-child(1) {\n        animation-delay: -0.45s;\n    }\n    .lds-ring div:nth-child(2) {\n        animation-delay: -0.3s;\n    }\n    .lds-ring div:nth-child(3) {\n        animation-delay: -0.15s;\n    }\n    @keyframes lds-ring {\n        0% {\n            transform: rotate(0deg);\n        }\n        100% {\n            transform: rotate(360deg);\n        }\n    }\n"], ["\n    width: 20px;\n    height: 20px;\n    .lds-ring {\n        display: inline-block;\n        position: relative;\n        width: 20px;\n        height: 20px;\n    }\n    .lds-ring div {\n        box-sizing: border-box;\n        display: block;\n        position: absolute;\n        width: 20px;\n        height: 20px;\n        margin: 0px;\n        border: 2px solid ", ";\n        border-radius: 50%;\n        animation: lds-ring 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite;\n        border-color: ", " transparent transparent transparent;\n    }\n    .lds-ring div:nth-child(1) {\n        animation-delay: -0.45s;\n    }\n    .lds-ring div:nth-child(2) {\n        animation-delay: -0.3s;\n    }\n    .lds-ring div:nth-child(3) {\n        animation-delay: -0.15s;\n    }\n    @keyframes lds-ring {\n        0% {\n            transform: rotate(0deg);\n        }\n        100% {\n            transform: rotate(360deg);\n        }\n    }\n"])), function (_a) {
    var color = _a.color;
    return color;
}, function (_a) {
    var color = _a.color;
...
var ViewNotificationItem = function (_a) {
    ...
    var rightIcon = chainName && ChainImages['CHAIN_ICONS'][chainName]; //get the right chain id to render if any
    console.log({
        chainName: chainName,
        rightIcon: rightIcon,
    ...
    // render
    return (React__namespace.createElement(Container, { timestamp: timeStamp, cta: MediaHelper.validURL(cta), onClick: gotToCTA, theme: theme },
        React__namespace.createElement(MobileHeader, { onClick: goToURL, theme: theme },
            React__namespace.createElement(HeaderButton, null,
                ...
                app),
            rightIcon && (React__namespace.createElement(HeaderImg, { src: rightIcon }))),
        React__namespace.createElement(ContentSection, null,
            ...
            React__namespace.createElement(ChannelDetailsWrapper, null,
                React__namespace.createElement(ChannelTitle, null,
                    React__namespace.createElement(ChannelTitleLink, { theme: theme }, notificationTitle)),
                React__namespace.createElement(ChannelDesc, null,
                    React__namespace.createElement(ChannelDescLabel, { theme: theme },
        ...
        React__namespace.createElement(ChannelMeta, { hidden: !timeStamp },
            React__namespace.createElement(React__namespace.Fragment, null,
                React__namespace.createElement(Pool, null,
                    React__namespace.createElement(PoolShare, { theme: theme }, timeStamp
                        ? moment__namespace
...
ViewNotificationItem.propTypes = {
    ...
    theme: PropTypes__namespace.string
};
...
var ContentSection = styled__default['default'].div(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n  display: block;\n  @media (min-width: ", ") {\n    margin-top: 5px;\n    align-items: center;\n    display: flex;\n    flex-direction: row;\n    gap: 20px;\n  }\n"], ["\n  display: block;\n  @media (min-width: ", ") {\n    margin-top: 5px;\n    align-items: center;\n    display: flex;\n    flex-direction: row;\n    gap: 20px;\n  }\n"])), SM_BREAKPOINT);
var HeaderImg = styled__default['default'].img(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  width: 30px;\n  height:30px;\n"], ["\n  width: 30px;\n  height:30px;\n"])));
var MobileImage = styled__default['default'].div(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  @media (min-width: ", ") {\n    width: 220px;\n    height: 200px;\n    img,\n    iframe,\n    video {\n      width: 100% !important;\n      height: 100% !important;\n      width: 100%;\n      object-fit: cover;\n      border-radius: 10px;\n      border: 0;\n    }\n  }\n  @media (max-width: ", ") {\n    display: block;\n    img,\n    iframe,\n    video {\n      border: 0;\n      width: calc(100% + 42px) !important;\n      margin-left: -20px;\n      // margin-right: -40px;\n      margin-top: -12px;\n      margin-bottom: 5px;\n    }\n  }\n"], ["\n  @media (min-width: ", ") {\n    width: 220px;\n    height: 200px;\n    img,\n    iframe,\n    video {\n      width: 100% !important;\n      height: 100% !important;\n      width: 100%;\n      object-fit: cover;\n      border-radius: 10px;\n      border: 0;\n    }\n  }\n  @media (max-width: ", ") {\n    display: block;\n    img,\n    iframe,\n    video {\n      border: 0;\n      width: calc(100% + 42px) !important;\n      margin-left: -20px;\n      // margin-right: -40px;\n      margin-top: -12px;\n      margin-bottom: 5px;\n    }\n  }\n"])), SM_BREAKPOINT, SM_BREAKPOINT);
var ImageContainer = styled__default['default'].span(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  background: rgba(231, 231, 231, 1);\n  height: 24px;\n  width: 24px;\n  display: inline-block;\n  margin-right: 10px;\n  border-radius: 5px;\n"], ["\n  background: rgba(231, 231, 231, 1);\n  height: 24px;\n  width: 24px;\n  display: inline-block;\n  margin-right: 10px;\n  border-radius: 5px;\n"])));
var ChannelDetailsWrapper = styled__default['default'].div(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n  //   align-self: center;\n"], ["\n  //   align-self: center;\n"])));
var Container = styled__default['default'].div(templateObject_6$1 || (templateObject_6$1 = __makeTemplateObject(["\n  position: relative;\n  overflow: hidden;\n  font-family: \"Source Sans Pro\", Arial, sans-serif;\n  flex: 1;\n  display: flex;\n  flex-wrap: wrap;\n  border: ", ";\n  cursor: ", ";\n\n  background: ", ";\n  border-radius: 10px;\n\n  margin: 15px 0px;\n  justify-content: center;\n  padding: 20px;\n\n  justify-content: space-between;\n\n  @media (max-width: ", ") {\n    flex-direction: column;\n    padding-top: 48px;\n    padding-bottom: ", ";\n  }\n"], ["\n  position: relative;\n  overflow: hidden;\n  font-family: \"Source Sans Pro\", Arial, sans-serif;\n  flex: 1;\n  display: flex;\n  flex-wrap: wrap;\n  border: ", ";\n  cursor: ", ";\n\n  background: ", ";\n  border-radius: 10px;\n\n  margin: 15px 0px;\n  justify-content: center;\n  padding: 20px;\n\n  justify-content: space-between;\n\n  @media (max-width: ", ") {\n    flex-direction: column;\n    padding-top: 48px;\n    padding-bottom: ", ";\n  }\n"])), function (props) {
    return props.cta
        ? "0.5px solid #35C5F3"
...
var MobileHeader = styled__default['default'].div(templateObject_7$1 || (templateObject_7$1 = __makeTemplateObject(["\n  display: none;\n  @media (max-width: ", ") {\n    cursor: pointer;\n    display: flex;\n    align-items: center;\n    position: absolute;\n    justify-content:space-between;  \n    top: 0;\n    left: 0;\n    right: 0;\n    padding: 6px 20px;\n    font-size: 14px;\n    border-bottom: 1px solid rgba(231, 231, 231, 1);\n    color: grey;\n    background: ", ";\n    border-top-left-radius: 10px;\n    border-top-right-radius: 10px;\n    text-align: left;\n  }\n"], ["\n  display: none;\n  @media (max-width: ", ") {\n    cursor: pointer;\n    display: flex;\n    align-items: center;\n    position: absolute;\n    justify-content:space-between;  \n    top: 0;\n    left: 0;\n    right: 0;\n    padding: 6px 20px;\n    font-size: 14px;\n    border-bottom: 1px solid rgba(231, 231, 231, 1);\n    color: grey;\n    background: ", ";\n    border-top-left-radius: 10px;\n    border-top-right-radius: 10px;\n    text-align: left;\n  }\n"])), MD_BREAKPOINT, function (props) { return (props.theme === "light" ? "rgba(250, 250, 250, 1)" : "#000"); });
var HeaderButton = styled__default['default'].div(templateObject_8$1 || (templateObject_8$1 = __makeTemplateObject(["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n"], ["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n"])));
var ChannelTitle = styled__default['default'].div(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  text-align: left;\n  margin-bottom: 10px;\n"], ["\n  text-align: left;\n  margin-bottom: 10px;\n"])));
var ChannelTitleLink = styled__default['default'].a(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  text-decoration: none;\n  color: #e20880;\n  font-size: 18px;\n  font-weight: 600;\n\n  @media (max-width: ", ") {\n    font-weight: 300;\n    color: ", ";\n  }\n"], ["\n  text-decoration: none;\n  color: #e20880;\n  font-size: 18px;\n  font-weight: 600;\n\n  @media (max-width: ", ") {\n    font-weight: 300;\n    color: ", ";\n  }\n"])), MD_BREAKPOINT, function (props) { return (props.theme === "light" ? "rgba(0, 0, 0, 0.5)" : "grey"); });
var ChannelDesc = styled__default['default'].div(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  line-height: 20px;\n  flex: 1;\n  display: flex;\n  font-size: 14px;\n  color: rgba(0, 0, 0, 0.75);\n  font-weight: 400;\n  flex-direction: column;\n"], ["\n  line-height: 20px;\n  flex: 1;\n  display: flex;\n  font-size: 14px;\n  color: rgba(0, 0, 0, 0.75);\n  font-weight: 400;\n  flex-direction: column;\n"])));
var ChannelDescLabel = styled__default['default'].label(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n  color: ", ";\n  flex: 1;\n  margin: 0px;\n  // font-weight: 600;\n  text-align: left;\n"], ["\n  color: ", ";\n  flex: 1;\n  margin: 0px;\n  // font-weight: 600;\n  text-align: left;\n"])), function (props) { return (props.theme === "light" ? "#000" : "#fff"); });
var ChannelMeta = styled__default['default'].div(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n  display: ", ";\n  flex-direction: row;\n  font-size: 13px;\n"], ["\n  display: ", ";\n  flex-direction: row;\n  font-size: 13px;\n"])), function (props) { return (props.hidden ? "none" : "flex"); });
var ChannelMetaBox = styled__default['default'].label(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n  color: #fff;\n  // font-weight: 600;\n  padding: 10px;\n  border-radius: 10px;\n  font-size: 12px;\n  align-self: flex-end;\n"], ["\n  color: #fff;\n  // font-weight: 600;\n  padding: 10px;\n  border-radius: 10px;\n  font-size: 12px;\n  align-self: flex-end;\n"])));
var Pool = styled__default['default'].div(templateObject_15 || (templateObject_15 = __makeTemplateObject(["\n  margin: 0px 10px;\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n"], ["\n  margin: 0px 10px;\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n"])));
var PoolShare = styled__default['default'](ChannelMetaBox)(templateObject_16 || (templateObject_16 = __makeTemplateObject(["\n  background: ", ";\n  @media (max-width: ", ") {\n    position: absolute;\n    bottom: 0;\n    right: 0;\n    border-radius: 0;\n    border-radius: 8px 0;\n    color: grey;\n    background: ", ";\n    border-top: 1px solid rgba(231, 231, 231, 1);\n    border-left: 1px solid rgba(231, 231, 231, 1);\n    padding: 5px 10px;\n  }\n"], ["\n  background: ", ";\n  @media (max-width: ", ") {\n    position: absolute;\n    bottom: 0;\n    right: 0;\n    border-radius: 0;\n    border-radius: 8px 0;\n    color: grey;\n    background: ", ";\n    border-top: 1px solid rgba(231, 231, 231, 1);\n    border-left: 1px solid rgba(231, 231, 231, 1);\n    padding: 5px 10px;\n  }\n"])), function (props) { return (props.theme === "light" ? "#674c9f" : "#000"); }, MD_BREAKPOINT, function (props) { return (props.theme === "light" ? "rgba(250, 250, 250, 1)" : "#000"); });
var SpamButton = styled__default['default'].div(templateObject_17 || (templateObject_17 = __makeTemplateObject(["\n  background: rgb(226, 8, 128);\n  padding: 10px 20px;\n  color: white;\n  border-radius: 3px;\n  cursor: pointer;\n  transition: 300ms;\n  margin-left: auto;\n  &:hover {\n    opacity: 0.9;\n  }\n"], ["\n  background: rgb(226, 8, 128);\n  padding: 10px 20px;\n  color: white;\n  border-radius: 3px;\n  cursor: pointer;\n  transition: 300ms;\n  margin-left: auto;\n  &:hover {\n    opacity: 0.9;\n  }\n"])));
...
var CLOSE_ICON = "https://backend-kovan.epns.io/assets/cross.png";

var SubscribedModal = function (_a) {
    ...
    useClickAway$1(modalRef, onClose);
    return (React__namespace.createElement(Overlay, { className: "overlay" },
        React__namespace.createElement(Modal, { className: "modal", ref: modalRef },
            React__namespace.createElement("img", { onClick: onClose, src: CLOSE_ICON, alt: "" }),
            React__namespace.createElement(Item, { className: "modal__heading" },
                React__namespace.createElement(CustomHeaderTwo, null,
                    React__namespace.createElement(CustomSpan, { style: { marginRight: "10px" } }, "Recieve"),
                    React__namespace.createElement(StyledSpan, null, "Notifications")),
                React__namespace.createElement(H3, null,
                    "Recieve notifications from ",
                    React__namespace.createElement("b", null, "EPNS"),
                    " via the following platforms.")),
            React__namespace.createElement(Item, { className: "modal__content" }, LINKS.map(function (oneLink) { return (React__namespace.createElement(ItemLink, { onClick: function () { return goto(oneLink.link); } },
                React__namespace.createElement("img", { src: oneLink.img, alt: "" }),
                oneLink.text)); })))));
};
var ItemLink = styled__default['default'].div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  width: 260px;\n  height: 62px;\n  padding-left: 22px;\n\n  background: #fafafa;\n  border: 0.2px solid rgba(0, 0, 0, 0.16);\n  box-sizing: border-box;\n  border-radius: 5px;\n  font-size: 0.75em;\n  text-transform: uppercase;\n  display: flex;\n  align-items: center;\n  gap: 1.3125em;\n\n  cursor: pointer;\n  transition: 300ms;\n\n  &:hover{\n    box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\n  }\n"], ["\n  width: 260px;\n  height: 62px;\n  padding-left: 22px;\n\n  background: #fafafa;\n  border: 0.2px solid rgba(0, 0, 0, 0.16);\n  box-sizing: border-box;\n  border-radius: 5px;\n  font-size: 0.75em;\n  text-transform: uppercase;\n  display: flex;\n  align-items: center;\n  gap: 1.3125em;\n\n  cursor: pointer;\n  transition: 300ms;\n\n  &:hover{\n    box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\n  }\n"])));
var CustomHeaderTwo = styled__default['default'].h2(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  margin-top: 0;\n  margin-bottom: 1em;\n  color: rgb(0, 0, 0);\n  font-weight: 600;\n  font-size: 1.5625em;\n  letter-spacing: 0.1em;\n  text-transform: uppercase;\n  padding: 0px;\n  font-family: inherit;\n  text-align: inherit;\n"], ["\n  margin-top: 0;\n  margin-bottom: 1em;\n  color: rgb(0, 0, 0);\n  font-weight: 600;\n  font-size: 1.5625em;\n  letter-spacing: 0.1em;\n  text-transform: uppercase;\n  padding: 0px;\n  font-family: inherit;\n  text-align: inherit;\n"])));
var Item = styled__default['default'].div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  text-transform: capitalise;\n\n  &.modal__heading {\n    margin-bottom: 3.3125rem;\n  }\n\n  &.modal__content {\n    display: grid;\n    grid-template-columns: 50% 50%;\n    grid-row-gap: 3.3125em;\n  }\n"], ["\n  display: flex;\n  flex-direction: column;\n  text-transform: capitalise;\n\n  &.modal__heading {\n    margin-bottom: 3.3125rem;\n  }\n\n  &.modal__content {\n    display: grid;\n    grid-template-columns: 50% 50%;\n    grid-row-gap: 3.3125em;\n  }\n"])));
var CustomSpan = styled__default['default'].span(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  flex: initial;\n  align-self: auto;\n  color: rgb(0, 0, 0);\n  background: transparent;\n  font-weight: 400;\n  font-size: inherit;\n  text-transform: inherit;\n  margin: 0px;\n  padding: 0px;\n  letter-spacing: inherit;\n  text-align: initial;\n  position: initial;\n  inset: auto;\n  z-index: auto;\n"], ["\n  flex: initial;\n  align-self: auto;\n  color: rgb(0, 0, 0);\n  background: transparent;\n  font-weight: 400;\n  font-size: inherit;\n  text-transform: inherit;\n  margin: 0px;\n  padding: 0px;\n  letter-spacing: inherit;\n  text-align: initial;\n  position: initial;\n  inset: auto;\n  z-index: auto;\n"])));
var StyledSpan = styled__default['default'](CustomSpan)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  background: rgb(226, 8, 128);\n  color: #fff;\n  font-weight: 600;\n  padding: 3px 8px;\n"], ["\n  background: rgb(226, 8, 128);\n  color: #fff;\n  font-weight: 600;\n  padding: 3px 8px;\n"])));
var H3 = styled__default['default'].h3(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  color: rgb(0 0 0 / 0.5);\n  font-weight: 300;\n  font-size: 1em;\n  text-transform: uppercase;\n  margin: -15px 0px 20px 0px;\n  padding: 0px;\n  letter-spacing: 0.1em;\n  font-family: \"Source Sans Pro\", Helvetica, sans-serif;\n  text-align: inherit;\n  max-width: initial;\n"], ["\n  color: rgb(0 0 0 / 0.5);\n  font-weight: 300;\n  font-size: 1em;\n  text-transform: uppercase;\n  margin: -15px 0px 20px 0px;\n  padding: 0px;\n  letter-spacing: 0.1em;\n  font-family: \"Source Sans Pro\", Helvetica, sans-serif;\n  text-align: inherit;\n  max-width: initial;\n"])));
var Overlay = styled__default['default'].div(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  top: 0;\n  left: 0;\n  right: 0;\n  background: rgba(0, 0, 0, 0.85);\n  height: 100%;\n  width: 100%;\n  z-index: 1000;\n  position: fixed;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  overflow-y: scroll;\n"], ["\n  top: 0;\n  left: 0;\n  right: 0;\n  background: rgba(0, 0, 0, 0.85);\n  height: 100%;\n  width: 100%;\n  z-index: 1000;\n  position: fixed;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  overflow-y: scroll;\n"])));
var Modal = styled__default['default'].div(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  padding: 3.875em;\n  background: white;\n  text-align: left;\n  border: 1px solid rgba(0, 0, 0, 0.16);\n  box-sizing: border-box;\n  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\n  border-radius: 15px;\n  position: relative;\n\n  &>img{\n    position: absolute;\n    right: 40px;\n    top: 40px;\n    cursor: pointer;\n  }\n\n  @media(max-width: 1000px){\n    width: max(70vw, 350px);\n    padding: 2em;\n    .modal__content {\n      display: flex;\n      flex-direction: column;\n      align-items: center;\n      gap: 20px\n    }\n  }\n"], ["\n  padding: 3.875em;\n  background: white;\n  text-align: left;\n  border: 1px solid rgba(0, 0, 0, 0.16);\n  box-sizing: border-box;\n  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\n  border-radius: 15px;\n  position: relative;\n\n  &>img{\n    position: absolute;\n    right: 40px;\n    top: 40px;\n    cursor: pointer;\n  }\n\n  @media(max-width: 1000px){\n    width: max(70vw, 350px);\n    padding: 2em;\n    .modal__content {\n      display: flex;\n      flex-direction: column;\n      align-items: center;\n      gap: 20px\n    }\n  }\n"])));
...
exports.OnSubscribeModal = SubscribedModal;
