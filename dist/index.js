...
var ImageWrapper = styled__default['default'].div(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n    height: 100vh;\n    width: 100vw;\n    background: rgba(0,0,0,0.75);\n    position: fixed;\n    top: 0;\n    left: 0;\n    justify-content: center;\n    align-items: center;\n    display: ", ";\n    z-index: 2;\n\n    img{\n        width: 80vw;\n        height: auto;\n        border-radius: 10px;\n    }\n"], ["\n    height: 100vh;\n    width: 100vw;\n    background: rgba(0,0,0,0.75);\n    position: fixed;\n    top: 0;\n    left: 0;\n    justify-content: center;\n    align-items: center;\n    display: ", ";\n    z-index: 2;\n\n    img{\n        width: 80vw;\n        height: auto;\n        border-radius: 10px;\n    }\n"])), function (props) { return props.visible ? 'flex' : 'none'; });
    ...
    isMediaYoutube: function (fileURL) {
        if (fileURL != undefined || fileURL != '') {
            ...
            if (match && match[2].length == 11) {
                // embed url
                var embedURL = 'https://www.youtube.com/embed/' + match[2] + '?autoplay=1&enablejsapi=1';
                return embedURL;
            }
        }
        return "";
...
var ViewNotificationItem = function (_a) {
    var notificationTitle = _a.notificationTitle, notificationBody = _a.notificationBody, cta = _a.cta, app = _a.app, icon = _a.icon, image = _a.image, url = _a.url;
    ...
    return (React__namespace.createElement(Container, { timestamp: timeStamp, cta: MediaHelper.validURL(cta), onClick: gotToCTA },
        ...
        React__namespace.createElement(ContentSection, null,
            ...
            !MediaHelper.isMediaSupportedVideo(image) ? (React__namespace.createElement(MobileImage, { style: { cursor: "pointer" }, onClick: function () { return setImageOverlay(image || ""); } },
                React__namespace.createElement("img", { src: image, alt: "" }))) : (
            // if its a youtube url, RENDER THIS
            MediaHelper.isMediaYoutube(image) ? (React__namespace.createElement(MobileImage, null,
                React__namespace.createElement("iframe", { id: "ytplayer", width: "640", height: "360", src: MediaHelper.isMediaExternalEmbed(image) }))) : (
...
var Container = styled__default['default'].div(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  position: relative;\n  overflow: hidden;\n  font-family: \"Source Sans Pro\",Arial,sans-serif;\n  flex: 1;\n  display: flex;\n  flex-wrap: wrap;\n  border: ", ";\n  cursor: ", ";\n\n  background: #fff;\n  border-radius: 10px;\n\n  margin: 15px 0px;\n  justify-content: center;\n  padding: 20px;\n\n  justify-content: space-between;\n\n  @media (max-width: ", "){\n    flex-direction: column;\n    padding-top: 48px;\n    padding-bottom: ", ";\n  }\n"], ["\n  position: relative;\n  overflow: hidden;\n  font-family: \"Source Sans Pro\",Arial,sans-serif;\n  flex: 1;\n  display: flex;\n  flex-wrap: wrap;\n  border: ", ";\n  cursor: ", ";\n\n  background: #fff;\n  border-radius: 10px;\n\n  margin: 15px 0px;\n  justify-content: center;\n  padding: 20px;\n\n  justify-content: space-between;\n\n  @media (max-width: ", "){\n    flex-direction: column;\n    padding-top: 48px;\n    padding-bottom: ", ";\n  }\n"])), function (props) { return props.cta ? "0.5px solid #35C5F3" : "1px solid rgba(231.0, 231.0, 231.0, 1);"; }, function (props) { return props.cta ? "pointer" : ""; }, MD_BREAKPOINT, function (props) { return props.timestamp ? "40px" : "22px"; });
...
var ChannelTitle = styled__default['default'].div(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  text-align: left;\n  margin-bottom: 10px\n"], ["\n  text-align: left;\n  margin-bottom: 10px\n"])));
var ChannelTitleLink = styled__default['default'].a(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  text-decoration: none;\n  color: #e20880;\n  font-size: 18px;\n  font-weight: 600;\n\n  @media (max-width: ", "){\n    font-weight: 300;\n    color: rgba(0.0, 0.0, 0.0, 0.5);\n  }\n"], ["\n  text-decoration: none;\n  color: #e20880;\n  font-size: 18px;\n  font-weight: 600;\n\n  @media (max-width: ", "){\n    font-weight: 300;\n    color: rgba(0.0, 0.0, 0.0, 0.5);\n  }\n"])), MD_BREAKPOINT);
var ChannelDesc = styled__default['default'].div(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  line-height: 20px;\n  flex: 1;\n  display: flex;\n  font-size: 14px;\n  color: rgba(0, 0, 0, 0.75);\n  font-weight: 400;\n  flex-direction: column;\n"], ["\n  line-height: 20px;\n  flex: 1;\n  display: flex;\n  font-size: 14px;\n  color: rgba(0, 0, 0, 0.75);\n  font-weight: 400;\n  flex-direction: column;\n"])));
var ChannelDescLabel = styled__default['default'].label(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  flex: 1;\n  margin: 0px;\n  // font-weight: 600;\n  text-align: left;\n"], ["\n  flex: 1;\n  margin: 0px;\n  // font-weight: 600;\n  text-align: left;\n"])));
var ChannelMeta = styled__default['default'].div(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  display: ", ";\n  flex-direction: row;\n  font-size: 13px;\n"], ["\n  display: ", ";\n  flex-direction: row;\n  font-size: 13px;\n"])), function (props) { return props.hidden ? "none" : "flex"; });
var ChannelMetaBox = styled__default['default'].label(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n  color: #fff;\n  // font-weight: 600;\n  padding: 10px;\n  border-radius: 10px;\n  font-size: 12px;\n  align-self: flex-end;\n"], ["\n  color: #fff;\n  // font-weight: 600;\n  padding: 10px;\n  border-radius: 10px;\n  font-size: 12px;\n  align-self: flex-end;\n"])));
var Pool = styled__default['default'].div(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n  margin: 0px 10px;\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n"], ["\n  margin: 0px 10px;\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n"])));
var PoolShare = styled__default['default'](ChannelMetaBox)(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n  background: #674c9f;\n  @media (max-width: ", "){\n    position: absolute;\n    bottom: 0;\n    right: 0;\n    border-radius: 0;\n    border-radius: 8px 0;\n    color: grey;\n    background: rgba(250.0, 250.0, 250.0, 1);\n    border-top: 1px solid rgba(231.0, 231.0, 231.0, 1);\n    border-left: 1px solid rgba(231.0, 231.0, 231.0, 1);\n    padding: 5px 10px;\n  }\n"], ["\n  background: #674c9f;\n  @media (max-width: ", "){\n    position: absolute;\n    bottom: 0;\n    right: 0;\n    border-radius: 0;\n    border-radius: 8px 0;\n    color: grey;\n    background: rgba(250.0, 250.0, 250.0, 1);\n    border-top: 1px solid rgba(231.0, 231.0, 231.0, 1);\n    border-left: 1px solid rgba(231.0, 231.0, 231.0, 1);\n    padding: 5px 10px;\n  }\n"
    // Export Default
])), MD_BREAKPOINT);
var templateObject_1, templateObject_2, templateObject_3, templateObject_4, templateObject_5, templateObject_6, templateObject_7, templateObject_8, templateObject_9, templateObject_10, templateObject_11, templateObject_12, templateObject_13, templateObject_14;

var config = {
    "NOTIFICATIONS_API": "https://backend-kovan.epns.io/apis/feeds/get_feeds",
