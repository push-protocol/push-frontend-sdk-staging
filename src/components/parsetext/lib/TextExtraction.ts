 ...
 */
 class TextExtraction {
     ...
     */
    public text: string;
    public patterns: CustomParseShape[];
     ...
     */
    parse() {
      let parsedTexts:any = [{ children: this.text }];
      ...
      return parsedTexts.filter((t:any) => !!t.children);
    }
     ...
     */
    getMatchedPart(matchedPattern: CustomParseShape,
       text:string, matches:[string], index:number) {
      let props = {};
