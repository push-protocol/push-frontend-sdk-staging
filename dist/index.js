...
var HeaderImg = styled__default['default'].img(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  width: 30px;\n  height:30px;\n"], ["\n  width: 30px;\n  height:30px;\n"])));
var MobileImage = styled__default['default'].div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  @media (min-width: ", ") {\n    width: 220px;\n    height: 200px;\n    img,\n    iframe,\n    video {\n      width: 100% !important;\n      height: 100% !important;\n      width: 100%;\n      object-fit: cover;\n      border-radius: 10px;\n      border: 0;\n    }\n  }\n  @media (max-width: ", ") {\n    display: block;\n    img,\n    iframe,\n    video {\n      border: 0;\n      width: calc(100% + 42px) !important;\n      margin-left: -20px;\n      // margin-right: -40px;\n      margin-top: -12px;\n      margin-bottom: 5px;\n    }\n  }\n"], ["\n  @media (min-width: ", ") {\n    width: 220px;\n    height: 200px;\n    img,\n    iframe,\n    video {\n      width: 100% !important;\n      height: 100% !important;\n      width: 100%;\n      object-fit: cover;\n      border-radius: 10px;\n      border: 0;\n    }\n  }\n  @media (max-width: ", ") {\n    display: block;\n    img,\n    iframe,\n    video {\n      border: 0;\n      width: calc(100% + 42px) !important;\n      margin-left: -20px;\n      // margin-right: -40px;\n      margin-top: -12px;\n      margin-bottom: 5px;\n    }\n  }\n"])), SM_BREAKPOINT, SM_BREAKPOINT);
var ImageContainer = styled__default['default'].span(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  background: rgba(231, 231, 231, 1);\n  height: 24px;\n  width: 24px;\n  display: inline-block;\n  margin-right: 10px;\n  border-radius: 5px;\n"], ["\n  background: rgba(231, 231, 231, 1);\n  height: 24px;\n  width: 24px;\n  display: inline-block;\n  margin-right: 10px;\n  border-radius: 5px;\n"])));
var ChannelDetailsWrapper = styled__default['default'].div(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  //   align-self: center;\n"], ["\n  //   align-self: center;\n"])));
var Container = styled__default['default'].div(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  position: relative;\n  overflow: hidden;\n  font-family: \"Source Sans Pro\", Arial, sans-serif;\n  flex: 1;\n  display: flex;\n  flex-wrap: wrap;\n  border: ", ";\n  cursor: ", ";\n\n  background: #fff;\n  border-radius: 10px;\n\n  margin: 15px 0px;\n  justify-content: center;\n  padding: 20px;\n\n  justify-content: space-between;\n\n  @media (max-width: ", ") {\n    flex-direction: column;\n    padding-top: 48px;\n    padding-bottom: ", ";\n  }\n"], ["\n  position: relative;\n  overflow: hidden;\n  font-family: \"Source Sans Pro\", Arial, sans-serif;\n  flex: 1;\n  display: flex;\n  flex-wrap: wrap;\n  border: ", ";\n  cursor: ", ";\n\n  background: #fff;\n  border-radius: 10px;\n\n  margin: 15px 0px;\n  justify-content: center;\n  padding: 20px;\n\n  justify-content: space-between;\n\n  @media (max-width: ", ") {\n    flex-direction: column;\n    padding-top: 48px;\n    padding-bottom: ", ";\n  }\n"])), function (props) {
    return props.cta
        ? "0.5px solid #35C5F3"
...
var MobileHeader = styled__default['default'].div(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  display: none;\n  @media (max-width: ", ") {\n    cursor: pointer;\n    display: flex;\n    align-items: center;\n    position: absolute;\n    justify-content:space-between;  \n    top: 0;\n    left: 0;\n    right: 0;\n    padding: 6px 20px;\n    font-size: 14px;\n    border-bottom: 1px solid rgba(231, 231, 231, 1);\n    color: grey;\n    background: rgba(250, 250, 250, 1);\n    border-top-left-radius: 10px;\n    border-top-right-radius: 10px;\n    text-align: left;\n  }\n"], ["\n  display: none;\n  @media (max-width: ", ") {\n    cursor: pointer;\n    display: flex;\n    align-items: center;\n    position: absolute;\n    justify-content:space-between;  \n    top: 0;\n    left: 0;\n    right: 0;\n    padding: 6px 20px;\n    font-size: 14px;\n    border-bottom: 1px solid rgba(231, 231, 231, 1);\n    color: grey;\n    background: rgba(250, 250, 250, 1);\n    border-top-left-radius: 10px;\n    border-top-right-radius: 10px;\n    text-align: left;\n  }\n"])), MD_BREAKPOINT);
var HeaderButton = styled__default['default'].div(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n"], ["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n"])));
